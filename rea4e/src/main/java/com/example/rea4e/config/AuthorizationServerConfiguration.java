...
public class AuthorizationServerConfiguration {
    ...
    @Bean
    @Order(1)//vai ser o primeiro filtro na cadeia
    public SecurityFilterChain serverSecurityFilterChain(HttpSecurity http) throws Exception{

        OAuth2AuthorizationServerConfiguration.applyDefaultSecurity(http);

        http.getConfigurer(OAuth2AuthorizationServerConfigurer.class)
            .oidc(Customizer.withDefaults());//openId

        http.oauth2ResourceServer(oauth2Rs -> oauth2Rs.jwt(Customizer.withDefaults()));//vai habilitar o jwt
        ...
        return context -> {
            ...
            if (principal instanceof CustomAuthentication authentication){
                ...
                if(OAuth2TokenType.ACCESS_TOKEN.equals(tipo)){
                    ...
                    List<String> authList = authorities
                    .stream()
